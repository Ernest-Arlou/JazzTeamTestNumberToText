...
#### Выполнение
Степени 10 выше третьей находятся в файле ExponentsOfTen.xlsx реализованы длинная и короткая шкала (протестирована только короткая)
Реализован DDT данные берутся из файла testPairs.csv